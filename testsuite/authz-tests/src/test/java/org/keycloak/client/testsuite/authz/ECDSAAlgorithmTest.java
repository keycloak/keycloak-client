...
import org.keycloak.client.testsuite.authz.util.DummyCryptoProvider;
...
public class ECDSAAlgorithmTest {
    ...
    private void test(ECDSAAlgorithm algorithm) throws Exception {
        DummyCryptoProvider prov = new DummyCryptoProvider();
        ...
        Assertions.assertArrayEquals(rsConcat, rsConcat2);
    }
