...
The {project_name} admin client aims to work with multiple versions of the {project_name} server. For the details about supported {project_name} server versions, see the <<upgrading,Upgrading section>>.
