...
public class Clients {
    ...
    Clients(Keycloak keycloak, ResteasyClientProvider CLIENT_PROVIDER, WebTarget target, String realmName) {
    ...
    public ClientsApi v2() {
        return CLIENT_PROVIDER.targetProxy(target, AdminApi.class).realms().realm(realmName).clients();
    }
