 ...
 */
public class AdminClientTest extends AbstractAdminClientTest {
    ...
    public List<RealmRepresentation> getRealmsForImport() {
        List<RealmRepresentation> testRealms = new ArrayList<>(super.getRealmsForImport());
        realmName = "test-admin-client";
